...
<head>
    ...
    <title>Privacy Policy | Dynasty Hosting</title>
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="https://billing.dynastyhosting.net/index.php?rp=/store/na-minecraft-hosting">Minecraft Hosting</a>
                                <a class="dropdown-item" href="https://billing.dynastyhosting.net/">Rust Hosting</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="https://billing.dynastyhosting.net/order/main/packages/webhosting/?group_id=3">Website Hosting</a>
                                <a class="dropdown-item" href="https://billing.dynastyhosting.net/">Dedicated Hosting Hosting</a>
                            </div>
                        </li>
                        <li class="nav-item">
    ...
    <footer>
        ...
        <div class="copyright">
            <div class="container">
                <h6 class="mb-0">Copyright © 2025 Lumi host | All Rights Reserved |
                </h6>
            </div>
        </div>
    </footer>
