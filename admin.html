    ...
    <section id="admin">
        <div class="container mt-5">
            <div class="section-title text-center">
                ...
                <h4>Admin Panel<span class="main">.</span></h4>
            </div>
                ...
                data.forEach(application => {
                    ...
                    applicationCard.innerHTML = `
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Position:</strong> ${application.position}</p>
                            <p class="card-text"><strong>Status:</strong> ${application.status}</p>
                            ${application.resume ? `<p class="card-text"><strong>Resume:</strong> <a href="${application.resume}" target="_blank">View</a></p>` : ''}
                            <button class="btn btn-success" onclick="updateStatus('${application.email}', 'Approved')">Approve</button>
                            <button class="btn btn-danger" onclick="updateStatus('${application.email}', 'Denied')">Deny</button>
                        </div>
                    `;
